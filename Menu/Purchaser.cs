...
public class Purchaser : MonoBehaviour, IStoreListener
{
    ...
    {
        BuyProductID(oneEuroDonation);
    }

    public void BuyThreeEuroDonation()
    {
        BuyProductID(threeEuroDonation);
    }

    public void BuyFiveEuroDonation()
    {
    ...
    {
        Debug.Log(string.Format("Successfully bought product with id '{0}'", args.purchasedProduct.definition.id));
