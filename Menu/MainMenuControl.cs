...
public class MainMenuControl : MonoBehaviour {
	...
	public void deletePlayer () {
		if (playerDropdown.options.Count > 0) {												//delete player if list has players
	...
	public void LoadByIndex() {																//Start-Button
		if (currentplayer!="")
	...
	public void acceptPlayerChoice () {													//Back-Button from Playerselect
	...
	public void showCurrentPlayerLevel (){	
		if (currentPlayerView != null) {														//show current player and selected level
	...
	public void populateLevelDropdown () {
			...
			if (currentplayer!=""){																	//add possible levels for player to dropdown
	...
	public void populatePlayerDropdown () {
		...
		foreach (string currentKey in PlayerStats.playerData.players.Keys) {						//get all players from Dictionary and put in dropdown
